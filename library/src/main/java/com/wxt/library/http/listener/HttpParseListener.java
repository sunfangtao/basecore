...
public interface HttpParseListener extends BaseHttpParseListener {
     ...
     */
    void onHttpSuccess(String type, JSONObject jsonObject, Object obj) throws Exception;
     ...
     */
    void onHttpSuccess(String type, JSONArray jsonArray, int page, int pageSize, int count, List<?> obj) throws Exception;
     ...
     */
    void onHttpSuccess(String type, String message, Object obj) throws Exception;
