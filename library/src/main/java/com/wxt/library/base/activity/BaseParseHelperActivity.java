...
public abstract class BaseParseHelperActivity extends BaseActivity implements HttpParseListener {
    ...
    @Override
    public void onHttpSuccess(final String type, final JSONObject jsonObject, Object obj) throws Exception {

    }

    @Override
    public void onHttpSuccess(final String type, final JSONArray jsonArray, final int page, final int pageSize, final int count, List obj) throws Exception {

    }

    @Override
    public void onHttpSuccess(final String type, final String message, Object obj) throws Exception {
