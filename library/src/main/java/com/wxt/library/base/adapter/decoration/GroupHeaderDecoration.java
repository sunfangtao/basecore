package com.wxt.library.base.adapter.decoration;
...
@NotProguard
public abstract class GroupHeaderDecoration extends RecyclerView.ItemDecoration {
    protected String TAG = "QDX";
    private Paint mHeaderTxtPaint;
    private Paint mHeaderContentPaint;

    protected int headerHeight = 90;//头部高度
    private int textPaddingLeft = 32;//头部文字左边距
    private int textSize = 32;
    private int textColor = Color.parseColor("#333333");
    private int headerContentColor = 0xffdddddd;
    private final float txtYAxis;
    private RecyclerView mRecyclerView;


    public GroupHeaderDecoration() {
